...
{
    public class LocalSiderealHourAngleDateTime : BaseLocalHourAngleDateTime
    {
        // Creates a new LocalSiderealHourAngleDateTime instance given the specified ILocalHourAngle argument.
        public LocalSiderealHourAngleDateTime(ILocalHourAngle localHourAngle)
            : base(localHourAngle)
        { }
            ...
            ILocalObserver localObserver, AstronomicalDateTime dateTime, Angle target, HourAngleCycle cycle)
        {
            ...
            // This is calculated in apparent sidereal time.
            ...
            AstronomicalDateTime result = AstronomicalDateTime.FromStandardTime(standardDateTime.Date)
