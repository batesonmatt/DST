...
namespace DST.Core.DateAndTime
{
    ...
    public static class DateTimeConstants
    {
        ...
        public static Calendar Calendar => new GregorianCalendar(GregorianCalendarTypes.Localized);
        ...
        public static DateTime Epoch => new(2000, 1, 1, 12, 0, 0, 0, Calendar, DateTimeKind.Utc);
        ...
        public static DateTime MinUtcDateTime => DateTime.SpecifyKind(Calendar.MinSupportedDateTime.AddDays(1), DateTimeKind.Utc);
        ...
        // converting to local time for any timezone, during any time of the year.
        public static DateTime MaxUtcDateTime => DateTime.SpecifyKind(Calendar.MaxSupportedDateTime.AddDays(-1), DateTimeKind.Utc);
