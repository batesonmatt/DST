...
namespace DST.Core.DateTimeAdder
{
    public class DaysAdder : BaseDateTimeAdder
    {
        ...
        // Returns a new IMutableDateTime value by adding the given amount of days to a 
        ...
        // Returns the string representation of this DaysAdder instance.
        public override string ToString()
        {
            return Resources.DisplayText.TimeUnitDays;
        }
    }
}